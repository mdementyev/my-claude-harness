...
description: Decompile .NET assemblies to see method bodies, private members, and internal implementation logic — the code behind the API surface. Use when dotnet-inspect's API queries aren't enough and you need to understand HOW code works internally, examine closed-source assemblies without SourceLink, view compiler-generated output, or analyze IL for performance investigation.
...
/usr/local/share/dotnet/shared/Microsoft.NETCore.App/8.0.0/System.Text.Json.dll
```
...
dnx ilspycmd -l class "/usr/local/share/dotnet/shared/Microsoft.NETCore.App/8.0.0/System.Text.Json.dll"

# Decompile JsonSerializer
dnx ilspycmd -t System.Text.Json.JsonSerializer "/usr/local/share/dotnet/shared/Microsoft.NETCore.App/8.0.0/System.Text.Json.dll"
```
...
# /usr/local/share/dotnet/shared/Microsoft.AspNetCore.App/8.0.0/

# Decompile the Kestrel server
dnx ilspycmd -l class "/usr/local/share/dotnet/shared/Microsoft.AspNetCore.App/8.0.0/Microsoft.AspNetCore.Server.Kestrel.Core.dll"

dnx ilspycmd -t Microsoft.AspNetCore.Server.Kestrel.Core.KestrelServer "/usr/local/share/dotnet/shared/Microsoft.AspNetCore.App/8.0.0/Microsoft.AspNetCore.Server.Kestrel.Core.dll"
```
